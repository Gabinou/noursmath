...
extern int32_t * pathfinding_Astar_Map_int32_t(int32_t * path_map, int32_t * costmap, size_t row_len, size_t col_len, struct nmath_point_int32_t start, struct nmath_point_int32_t end);

extern int32_t * came_from2path_list(int32_t * path_list, int32_t * came_from, size_t row_len, size_t col_len, int32_t x_start, int32_t y_start, int32_t x_end, int32_t y_end);

extern int32_t * came_from2path_map(int32_t * path_map, int32_t * came_from, size_t row_len, size_t col_len, int32_t x_start, int32_t y_start, int32_t x_end, int32_t y_end);
...
#define REGISTER_ENUM(type) extern struct nmath_sq_neighbors_##type pathfinding_Direction_Pushto_##type(type * assailablemap, size_t row_len, size_t col_len, int8_t range[2], struct nmath_point_##type target);
TEMPLATE_TYPES_SINT
#undef REGISTER_ENUM

#define REGISTER_ENUM(type) extern struct nmath_sq_neighbors_##type pathfinding_Direction_Pullto_##type(type * assailablemap, size_t row_len, size_t col_len, int8_t range[2], struct nmath_point_##type target);
TEMPLATE_TYPES_SINT
#undef REGISTER_ENUM
...
#define REGISTER_ENUM(type) extern type * pathfinding_Map_Attackfrom_##type(type * in_movemap, size_t row_len, size_t col_len, struct nmath_point_##type in_target, int8_t range[2], uint8_t mode_output);
TEMPLATE_TYPES_SINT
#undef REGISTER_ENUM
